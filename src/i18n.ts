...
const STRINGS = {
  ...
  theEnd: { en: "The End", zh: "終" },
  thanksForPlaying: { en: "Thank you for journeying through Aetheria.", zh: "感謝你與艾特利亞一同走過這段旅程。" },
  finalChapter: { en: "Final Chapter", zh: "終章" },
  completedChapters: { en: "Chapters completed:", zh: "已完成章節：" },
  returnToTitle: { en: "Return to Title", zh: "返回主選單" },
  continueToEpilogue: { en: "Continue to Epilogue", zh: "繼續結局" },
  // Action Menu extra
  item: { en: "Item", zh: "道具" },
