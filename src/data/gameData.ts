...
export const UNITS: Record<string, UnitDef> = {
  kael: { id: "kael", name: "Kael", desc: "A seasoned warrior-lord, scarred by years of border conflict. The Black Knight of Ashwood.", classId: "lord", level: 1, faction: "player", isLord: true, growthBonus: { hp: 15, str: 10, skl: 10, spd: 10, lck: 10, def: 10, res: 10 }, inventory: ["iron_sword"], modelId: "Paladin", portraitColor: "#3a6ad8" },
  ...
  borin: { id: "borin", name: "Borin", desc: "Veteran knight of the old guard.", classId: "knight", level: 3, faction: "player", growthBonus: { hp: 15, str: 10, def: 15 }, inventory: ["iron_lance"], modelId: "Paladin_with_Helmet", portraitColor: "#686872" },
