...
export const UNITS: Record<string, UnitDef> = {
  ...
  bandit_sword: { id: "bandit_sword", name: "Bandit", desc: "A common brigand. No loyalty, no cause — just coin and survival.", classId: "mercenary", level: 1, faction: "enemy", inventory: ["iron_sword"], modelId: "Skeleton_Warrior", portraitColor: "#8a4a2a" },
  bandit_axe: { id: "bandit_axe", name: "Brigand", desc: "A muscular thug who lives by the axe. Crude but dangerous.", classId: "fighter", level: 2, faction: "enemy", inventory: ["iron_axe"], modelId: "Skeleton_Warrior", portraitColor: "#6a3a1a" },
  boss_garrick: { id: "boss_garrick", name: "Garrick the Cruel", desc: "Leader of the Ashwood Bandits. Wears the Umbral sigil unknowingly — a pawn in a larger game.", classId: "fighter", level: 3, faction: "enemy", isBoss: true, growthBonus: { hp: 20, str: 15, def: 10 }, inventory: ["steel_sword"], modelId: "Skeleton_Warrior", portraitColor: "#9a1a1a" },
  umbral_mage: { id: "umbral_mage", name: "Umbral Acolyte", desc: "A cultist channeling corrupted fire magic. Fanatical devotee of the Endless Night.", classId: "mage", level: 3, faction: "enemy", inventory: ["fire"], modelId: "Skeleton_Mage", portraitColor: "#5a1a6a" },
  // New recruits
  ...
  // Cult enemies
  cultist: { id: "cultist", name: "Cultist", desc: "A fanatical follower of the Endless Night. Armed and dangerous.", classId: "mercenary", level: 4, faction: "enemy", inventory: ["iron_sword"], modelId: "Skeleton_Warrior", portraitColor: "#4a1a4a" },
  cultist_heavy: { id: "cultist_heavy", name: "Cult Enforcer", desc: "A heavily armed cult enforcer. The backbone of the Cult's military strength.", classId: "fighter", level: 6, faction: "enemy", inventory: ["iron_axe"], modelId: "Skeleton_Warrior", portraitColor: "#3a0a3a" },
  cult_archer: { id: "cult_archer", name: "Cult Archer", desc: "A cult ranged unit. Trained to strike from the shadows.", classId: "archer", level: 4, faction: "enemy", inventory: ["iron_bow"], modelId: "Skeleton_Rogue", portraitColor: "#4a2a1a" },
  acolyte_veyne: { id: "acolyte_veyne", name: "Acolyte Veyne", desc: "A mid-ranking Umbral Cult leader. The one who corrupted the Shrine of Embers.", classId: "mage", level: 8, faction: "enemy", isBoss: true, growthBonus: { mag: 25, res: 20 }, inventory: ["fire"], modelId: "Skeleton_Mage", portraitColor: "#6a0a6a" },
